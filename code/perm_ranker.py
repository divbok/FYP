...
#Y = dataset['']
#print(dataset)
chi_square_file = "results_new/chisquare_results.txt"
...
results = [a+","+str(b)+","+str(c)+","+str(d)+","+str(e)+"," + str((b+c)/(mal_size+ben_size)) for a,b,c,d,e in zip(perm_list,msum_col,bsum_col,support_perm,rank) if math.isnan(e) is False]
